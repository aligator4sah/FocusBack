...
let SocialNetworkController = class SocialNetworkController {
    constructor(socialNetworkService) {
        this.socialNetworkService = socialNetworkService;
    }
    addSocialNetwork(socialNetworks) {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = yield this.socialNetworkService.addSocialNetwork(socialNetworks);
            return msg;
        });
    }
    findAllSocialNetwork() {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = yield this.socialNetworkService.findAllSocialNetwork();
            return msg;
        });
    }
...
], SocialNetworkController.prototype, "addSocialNetwork", null);
__decorate([
    common_1.Get(),
    __metadata("design:type", Function),
...
exports.SocialNetworkController = SocialNetworkController;
//# sourceMappingURL=socialNetwork.controller.js.map