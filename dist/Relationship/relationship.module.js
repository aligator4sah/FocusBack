...
const relationship_controller_1 = require("./relationship.controller");
const relationship_service_1 = require("./relationship.service");
const relationship_providers_1 = require("./relationship.providers");
let RelationshipModule = class RelationshipModule {
};
RelationshipModule = __decorate([
    common_1.Module({
        imports: [database_module_1.DatabaseModule],
        controllers: [relationship_controller_1.RelationshipController],
        components: [
            relationship_service_1.RelationshipService,
            relationship_providers_1.relationshipProvider
        ]
    })
], RelationshipModule);
