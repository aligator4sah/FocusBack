...
let RelationshipService = class RelationshipService {
    ...
    getAllRelationship() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.relationshipRepository.find();
        });
    }
    addRelationship(relationship) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.relationshipRepository.save(relationship);
        });
    }
};
RelationshipService = __decorate([
    common_1.Component(),
    __param(0, common_1.Inject('RelationshipRepository')),
